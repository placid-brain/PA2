...
public class ServerFulfillingCP1{
        ...
        try {
            ...
            while (!connectionSocket.isClosed()) {
                ...
                if (packetType == 0) {
                    ...
                    //decrypt on receive
                    //String decryptedBlockString = rsa.decrypt(block, privateKey);
                    //byte[] decryptedBlock = decryptedBlockString.getBytes();
                    //System.out.println("Decrypted block :"+decryptedBlockString);

                    byte[] decryptedBlock1 = rsa.decryptInBytes(block, privateKey);
                    //System.out.println(decryptedBlock == decryptedBlock1);

                    if (encryptedNumBytes > 0)
                        System.out.println("writing to the file");
                    System.out.println("num bytes : "+ numBytes);
                    bufferedFileOutputStream.write(decryptedBlock1, 0, numBytes);
